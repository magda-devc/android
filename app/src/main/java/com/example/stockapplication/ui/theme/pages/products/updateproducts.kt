...
fun UpdateProductsScreen(navController: NavHostController,id:String) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        var productItemType by remember { mutableStateOf(TextFieldValue(name)) }
        ...
        Button(onClick = {
            ...
            productRepository.updateProduct(productName.text.trim(),productItemType.text.trim(),productQuantity.text.trim(),
