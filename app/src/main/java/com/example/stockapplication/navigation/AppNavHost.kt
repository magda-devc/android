...
import com.example.stockapplication.ui.theme.pages.products.AddProductsScreen
import com.example.stockapplication.ui.theme.pages.products.NewStockScreen
import com.example.stockapplication.ui.theme.pages.products.OldStockScreen
...
fun AppNavHost(modifier: Modifier = Modifier,
    ...
    NavHost(navController = navController,
        ...
        composable(ROUTE_OLD_STOCK){
            OldStockScreen(navController)
        }
